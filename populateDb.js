...
function onScan(err, data) {
  if (err) {
    ...
    https.request(`https://api.edmunds.com/v1/api/maintenance/recallrepository/findbymodelyearid?modelyearid=${data.Items[0].modelYearId}&fmt=json&api_key=68da4xqgp74rvhph299vsebk`, (res) => {
